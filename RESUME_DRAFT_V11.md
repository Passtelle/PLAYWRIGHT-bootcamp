...
Test Management: Jira, Xray, BDD/Gherkin, JUnit XML auto-upload, Xray Cloud API, automated Test Execution creation

AI-Augmented QA: Claude Code, GitHub Copilot, Gemini (Judge LLM), multi-agent orchestration, prompt engineering for test generation

Security Testing: Penetration testing, SQL injection, boundary analysis, IBM AppScan, Nexpose, Acunetix, Metasploit, Wireshark, Fiddler2

Test Data: Faker.js, dynamic data factories, no hardcoded values, dotenv, GitHub Secrets

Domain Knowledge: FinTech, blockchain, DeFi and Web3, crypto markets, regulated financial systems

---

EXPERIENCE

Senior QA Engineer, AI-Driven Automation Portfolio | IB Croc LLC
December 2025 - Present | Atlanta, GA (Remote)
...
Independent Trader and Digital Product Creator | IB Croc LLC
February 2023 - November 2025 | Atlanta, GA
...
- Designed DigitPilot (digitpilot.io), an AI-powered crypto trading education platform, prototyping the full product in Figma AI and building a live website with a waitlist, curriculum and expert blog, proving the ability to take a product from idea to launch independently


Career Break | January 2016 - January 2023
...
Freelance Senior QA Engineer | Self-Employed
September 2011 - December 2015 | International Clients (Remote)
...
Senior QA Analyst III | Fiserv
April 2008 - September 2011 | Atlanta, GA
...
Senior QA Engineer | IBM Internet Security Systems
September 2000 - April 2008 | Atlanta, GA
...
Claude Code 101 | Anthropic | April 2026
